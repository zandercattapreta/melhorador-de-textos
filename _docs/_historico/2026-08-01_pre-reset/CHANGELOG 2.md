...
### Adicionado
- PoC de pipeline OCR: CLI `melhorador-textos` (Python 3.12) com comandos `extract`, `prepare-lt`, `import-lt`.
...
- `pyproject.toml`, `src/melhorador_textos/`, `tests/`; `.gitignore` protegendo `_output/`.
